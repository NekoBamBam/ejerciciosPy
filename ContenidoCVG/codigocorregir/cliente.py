...
class Cliente:
    ...
    def __str__(self) -> str:
        ...
        datos_personales = (
            f"Nombre: {self.nombre_formateado}, CUIL: {self.cuil_formateado}"
        )
        cotacto = (
            f"Mail: {self.mail}, Tel: {self.telefono}, Dir: {self.direccion_formateado}"
        )
...
class Empresa(Cliente):
    def __init__(
        self, nombre_juridico, cuil, mail, telefono, direccion, nombre_fantasia
    ):
